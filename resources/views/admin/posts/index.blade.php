...
{{-- MODAL FORM ADD/EDIT --}}
<div class="modal fade" id="postModal" tabindex="-1" role="dialog" data-backdrop="false">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div id="detail-image-wrapper" class="mb-3" style="display:none;">
                  <img id="detail-image" src="" alt="" class="img-fluid rounded" style="max-height:250px;">
              </div>
...
CKEDITOR.replace('body', {
    ...
    // ambil URL gambar dari response (image_url / image_path / fallback)
    ...
    $(document).on('click', '.btn-detail-post', function () {
        ...
        $.get("{{ route('admin.posts.index') }}/" + id, function (res) {
